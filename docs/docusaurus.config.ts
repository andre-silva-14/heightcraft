...
const config: Config = {
  ...
  url: 'https://andre-silva-14.github.io',
  ...
  organizationName: 'andre-silva-14', // Usually your GitHub org/user name.
  projectName: 'heightcraft', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/andre-silva-14/heightcraft',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        {
          ...
          items: [
            ...
            {
              label: 'AI Upscaling',
              to: '/docs/guides/ai-upscaling',
            },
            {
              label: 'LiDAR Processing',
              to: '/docs/guides/lidar-processing',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Heightcraft Team. Built with Docusaurus.`,
    },
    prism: {
